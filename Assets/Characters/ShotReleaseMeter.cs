...
public class ShotReleaseMeter : MonoBehaviour
{
    [SerializeField] ShootBall shootBall;
    ...
    private readonly float meterIncrement =0.05f; // value between 0 - 1
